...
Patch\_\-Group\_\-s {\bfseries create\_\-patch\_\-group} (std::string name, std::map$<$ std::string, real $>$ v\_\-0, std::map$<$ std::string, real $>$ S, real v\_\-0\_\-point\mbox{[}2\mbox{]})}
